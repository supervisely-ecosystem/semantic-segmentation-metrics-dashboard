...
def convert_projects_to_semantic_segmentation_task(target_classes_names_list):
    ...
    print('initializing_pred')

    progress_cb2 = card_widgets.select_classes_progress(message='PRED project to Segmentation Task',
    ...
    supervisely.Project.to_segmentation_task(src_project_dir=g.pred_project_dir,
                                             ...
                                             target_classes=target_classes_names_list,
                                             progress_cb=progress_cb2.update)

    progress_cb3 = card_widgets.select_classes_progress(message='TEST iter',
                                                        total=10)
